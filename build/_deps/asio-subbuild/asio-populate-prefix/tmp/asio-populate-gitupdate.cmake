...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "asio-1-32-0"
  WORKING_DIRECTORY "/Users/christian/Documents/feature-serving-engine/build/_deps/asio-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("asio-1-32-0" tag_sha error_msg)
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: asio-1-32-0")
    return()
  endif()
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/asio-1-32-0")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"asio-1-32-0\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/christian/Documents/feature-serving-engine/build/_deps/asio-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/christian/Documents/feature-serving-engine/build/_deps/asio-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
